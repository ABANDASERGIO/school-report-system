...
export const DEFAULT_SETTINGS = [
  ...
  { key: 'teacher_comment', value: '', description: 'Default class teacher comment on report cards' },
  { key: 'principal_comment', value: '', description: 'Default principal comment on report cards' },
  { key: 'promotion_decision', value: '', description: 'Default promotion decision on report cards' },
